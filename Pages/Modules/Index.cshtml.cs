...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public class IndexModel : DI_BasePageModel
    {
        ...
        {
            var modules = Context.Module.AsNoTracking().Join(Context.Templates, a => a.Template, b => b.TemplateID, (a, b) => new Module { ModuleId=a.ModuleId,Name=a.Name,Template=b.Name,Status=a.Status,TimeStamp=a.TimeStamp});
